        ...
        <div class="container">
            ...
            <div class=" contact-w3">
                <div class="col-md-5 contact-right">
                    <img src="{{ asset('/frontend/images/cac.jpg') }}" class="img-responsive" alt="">
                    <iframe
                        src="//www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d456.3230170714877!2d90.42379602503212!3d23.79781879956588!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c799d57cf845%3A0xf94fcd9792977d06!2sNoton%20bazar%20point!5e0!3m2!1sen!2sbd!4v1680931674395!5m2!1sen!2sbd" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"
                    ...
                    <div id="container">
                        ...
                        <div id="parentHorizontalTab">
                            ...
                            <div class="resp-tabs-container hor_1">
                                <div>
                                    <form role="form" action="{{ route('user_contact.store') }}" method="post"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <input type="text" value="Name" name="name" onfocus="this.value = '';"
                                        onblur="if (this.value == '') {this.value = 'Name';}" required="">

                                        <input type="text" value="Address" name="address" onfocus="this.value = '';"
                                            onblur="if (this.value == '') {this.value = 'Address';}" required="">
